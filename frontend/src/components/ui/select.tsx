...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-9 w-full items-center justify-between rounded-lg border border-gray-700',
      'bg-gray-800 px-3 py-2 text-sm text-gray-100 shadow-sm',
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-lg border border-gray-700 bg-gray-900 text-gray-100 shadow-xl',
